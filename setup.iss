[Setup]
AppName=The Planet Crafter by StormGamesStudios
AppVersion=1.0.5
DefaultDirName={userappdata}\StormGamesStudios\NewGameDir\ThePlanetCrafterGame
DefaultGroupName=StormGamesStudios
OutputDir=C:\Users\melio\Documents\GitHub\ThePlanetCrafterGame\output
OutputBaseFilename=ThePlanetCrafterGame_Launcher_Installer
Compression=lzma
...
SetupIconFile=theplanetcrafter.ico
...
[Files]
Source: "C:\Users\melio\Documents\GitHub\ThePlanetCrafterGame\dist\installer_updater.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\Users\melio\Documents\GitHub\ThePlanetCrafterGame\theplanetcrafter.ico"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\Users\melio\Documents\GitHub\ThePlanetCrafterGame\theplanetcrafter.png"; DestDir: "{app}"; Flags: ignoreversion

[Icons]
Name: "{commonprograms}\StormGamesStudios\The Planet Crafter"; Filename: "{app}\installer_updater.exe"; IconFilename: "{app}\theplanetcrafter.ico"; Comment: "Lanzador de The Planet Crafter"; WorkingDir: "{app}"
...
[Run]
Filename: "{app}\installer_updater.exe"; Description: "Ejecutar The Planet Crafter"; Flags: nowait postinstall skipifsilent
...
begin
  ...
  RunUninstaller(ExpandConstant('{userappdata}\StormGamesStudios\NewGameDir\ThePlanetCrafterGame'));
...
begin
  ...
  Exec('taskkill', '/F /IM "PlanetCrafter.exe"', '', SW_HIDE, ewWaitUntilTerminated, ResultCode);
